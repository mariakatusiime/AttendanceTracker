            ...
            public void surfaceCreated(SurfaceHolder surfaceHolder) {
                try{
                    if (ActivityCompat.checkSelfPermission(getApplicationContext(), CAMERA) == PackageManager.PERMISSION_GRANTED) {
                        ...
                        ActivityCompat.requestPermissions(Main5Activity.this, new String[]{CAMERA},
                ...
                if(qrcodes.size()!=0) {
                    txtresult.post(new Runnable() {
                        ...
                        public void run() {
                            ...
                            if( value.equals("")) {
                                Toast.makeText(Main5Activity.this, "No value to be passed",Toast.LENGTH_LONG).show();
                            }
                            else
                            {
                                Intent intent = new Intent(Main5Activity.this, org.livinggoods.myapp.Branches.Budadiri.class);
