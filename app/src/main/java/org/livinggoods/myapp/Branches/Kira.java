...
public class Kira extends AppCompatActivity {
...
//        value = getIntent().getStringExtra("value");
        ...
        Scanbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                  ...
                  ActivityCompat.startActivityForResult(Kira.this, new Intent(Kira.this, Main3Activity.class), 0, null);
//                Intent intent = new Intent(Kira.this,Main3Activity.class);
//                startActivity(intent);
        ...
        private void sendPost (String value){
        ...
        Call<AirTableResponse> call = mAitTableApi.sendPost(request);
